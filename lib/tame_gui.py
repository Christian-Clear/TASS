...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Tue Sep  7 13:58:12 2021
#
...
from lib import matplotlib_canvas
from lib.GroupListViewTASS import GroupListViewTame
from lib.ObjectListView import ObjectListView
from lib.ObjectListViewTASS import ObjectListViewTame
# end wxGlade
...
class mainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        _icon = wx.NullIcon
        _icon.CopyFromBitmap(wx.Bitmap("/home/christian/Desktop/TASS/resources/TAME_Logo.png", wx.BITMAP_TYPE_ANY))
        self.SetIcon(_icon)
        ...
        wxglade_tmp_menu = wx.Menu()
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "Lost Lines", "")
        self.Bind(wx.EVT_MENU, self.on_lost_lines, item)
        ...
        tool = self.frame_toolbar.AddTool(wx.ID_ANY, "Run Strans", wx.ArtProvider.GetBitmap(wx.ART_GO_FORWARD, wx.ART_TOOLBAR, (24, 24)), wx.NullBitmap, wx.ITEM_NORMAL, "", "Run Line Matching")
        self.Bind(wx.EVT_TOOL, self.on_full_strans, id=tool.GetId())
        tool = self.frame_toolbar.AddTool(wx.ID_ANY, "Run Lopt", wx.ArtProvider.GetBitmap(wx.ART_GOTO_LAST, wx.ART_TOOLBAR, (24, 24)), wx.NullBitmap, wx.ITEM_NORMAL, "", "Run Level Optimisation")
        self.Bind(wx.EVT_TOOL, self.on_lopt, id=tool.GetId())
        tool = self.frame_toolbar.AddTool(wx.ID_ANY, "Redo", wx.ArtProvider.GetBitmap(wx.ART_REDO, wx.ART_TOOLBAR, (24, 24)), wx.NullBitmap, wx.ITEM_NORMAL, "", "Run Level Prediction")
        self.Bind(wx.EVT_TOOL, self.on_levhams, id=tool.GetId())
        self.frame_toolbar.AddSeparator()
        ...
        self.main_panel.AddPage(self.STRANS, "Line Matching")
        ...
        self.main_panel.AddPage(self.LOPT, "Level Optimisation")
        ...
        self.lopt_line_panel_header.SetFont(wx.Font(16, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        ...
        self.lopt_line_listctrl = wx.ListCtrl(self.lopt_line_panel, wx.ID_ANY, style=wx.BORDER_THEME | wx.LC_HRULES | wx.LC_REPORT)
        ...
        sizer_13.Add(grid_sizer_1, 1, wx.ALL | wx.EXPAND, 5)

        self.incorr_assign_chkbox = wx.CheckBox(self.lopt_line_panel, wx.ID_ANY, "Incorrect Assignment")
        grid_sizer_1.Add(self.incorr_assign_chkbox, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        self.main_panel.AddPage(self.LEVHAMS, "Level Prediction")

        sizer_4 = wx.BoxSizer(wx.VERTICAL)

        self.window_3 = wx.SplitterWindow(self.LEVHAMS, wx.ID_ANY)
        self.window_3.SetMinimumPaneSize(20)
        sizer_4.Add(self.window_3, 1, wx.EXPAND, 0)

        self.window_3_pane_1 = wx.Panel(self.window_3, wx.ID_ANY, style=wx.FULL_REPAINT_ON_RESIZE | wx.TAB_TRAVERSAL)

        sizer_19 = wx.BoxSizer(wx.VERTICAL)

        self.levhams_level_listctrl = wx.ListCtrl(self.window_3_pane_1, wx.ID_ANY, style=wx.BORDER_THEME | wx.LC_HRULES | wx.LC_REPORT)
        self.levhams_level_listctrl.AppendColumn("       Label", format=wx.LIST_FORMAT_LEFT, width=200)
        self.levhams_level_listctrl.AppendColumn("J", format=wx.LIST_FORMAT_LEFT, width=50)
        self.levhams_level_listctrl.AppendColumn("Energy (cm-1)", format=wx.LIST_FORMAT_LEFT, width=150)
        self.levhams_level_listctrl.AppendColumn("Parity", format=wx.LIST_FORMAT_LEFT, width=100)
        sizer_19.Add(self.levhams_level_listctrl, 1, wx.ALL | wx.EXPAND, 5)

        sizer_20 = wx.StaticBoxSizer(wx.StaticBox(self.window_3_pane_1, wx.ID_ANY, "LEVHAMS Settings"), wx.HORIZONTAL)
        sizer_19.Add(sizer_20, 0, wx.ALL | wx.EXPAND, 3)

        levhams_inputs = wx.GridSizer(2, 2, 3, 3)
        sizer_20.Add(levhams_inputs, 1, wx.ALL | wx.EXPAND, 3)

        sizer_22 = wx.BoxSizer(wx.VERTICAL)
        levhams_inputs.Add(sizer_22, 1, wx.EXPAND, 0)

        label_6 = wx.StaticText(self.window_3_pane_1, wx.ID_ANY, "Tolerance (cm-1)")
        sizer_22.Add(label_6, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, 0)

        self.levhams_tol_spinctrl = wx.SpinCtrlDouble(self.window_3_pane_1, wx.ID_ANY, initial=0.005, min=0.0, max=100.0)
        self.levhams_tol_spinctrl.SetIncrement(0.001)
        self.levhams_tol_spinctrl.SetDigits(4)
        sizer_22.Add(self.levhams_tol_spinctrl, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, 0)

        sizer_23 = wx.BoxSizer(wx.VERTICAL)
        levhams_inputs.Add(sizer_23, 1, wx.EXPAND, 0)

        label_4 = wx.StaticText(self.window_3_pane_1, wx.ID_ANY, "Min. No. of Matches")
        sizer_23.Add(label_4, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, 0)

        self.levhams_num_spinctrl = wx.SpinCtrl(self.window_3_pane_1, wx.ID_ANY, "5", min=0, max=100)
        sizer_23.Add(self.levhams_num_spinctrl, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, 0)

        sizer_24 = wx.BoxSizer(wx.VERTICAL)
        levhams_inputs.Add(sizer_24, 1, wx.EXPAND, 0)

        label_5 = wx.StaticText(self.window_3_pane_1, wx.ID_ANY, "Line Selection")
        sizer_24.Add(label_5, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, 0)

        levhams_rb_sizer = wx.BoxSizer(wx.VERTICAL)
        sizer_24.Add(levhams_rb_sizer, 1, wx.ALIGN_CENTER_HORIZONTAL, 0)

        self.levhams_all_rbutton = wx.RadioButton(self.window_3_pane_1, wx.ID_ANY, "All Lines", style=wx.RB_GROUP)
        levhams_rb_sizer.Add(self.levhams_all_rbutton, 0, 0, 0)

        self.levhams_unident_rbutton = wx.RadioButton(self.window_3_pane_1, wx.ID_ANY, "Unidentified Lines")
        levhams_rb_sizer.Add(self.levhams_unident_rbutton, 0, 0, 0)

        sizer_25 = wx.BoxSizer(wx.VERTICAL)
        levhams_inputs.Add(sizer_25, 1, wx.EXPAND, 0)

        label_3 = wx.StaticText(self.window_3_pane_1, wx.ID_ANY, "Wavenumber Range (cm-1)")
        sizer_25.Add(label_3, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, 0)

        sizer_26 = wx.BoxSizer(wx.VERTICAL)
        sizer_25.Add(sizer_26, 1, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, 3)

        sizer_27 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_26.Add(sizer_27, 1, wx.EXPAND, 0)

        label_7 = wx.StaticText(self.window_3_pane_1, wx.ID_ANY, "Min:  ")
        sizer_27.Add(label_7, 0, 0, 0)

        self.levhams_wn_min_spinctrl = wx.SpinCtrlDouble(self.window_3_pane_1, wx.ID_ANY, initial=0.0, min=0.0, max=100000000.0)
        self.levhams_wn_min_spinctrl.SetDigits(0)
        self.levhams_wn_min_spinctrl.SetIncrement(1000.0)
        sizer_27.Add(self.levhams_wn_min_spinctrl, 0, 0, 0)

        sizer_28 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_26.Add(sizer_28, 1, wx.EXPAND, 0)

        label_8 = wx.StaticText(self.window_3_pane_1, wx.ID_ANY, "Max: ")
        sizer_28.Add(label_8, 0, 0, 0)

        self.levhams_wn_max_spinctrl = wx.SpinCtrlDouble(self.window_3_pane_1, wx.ID_ANY, initial=0.0, min=0.0, max=100000000.0)
        self.levhams_wn_max_spinctrl.SetDigits(0)
        self.levhams_wn_max_spinctrl.SetIncrement(1000.0)
        self.levhams_wn_max_spinctrl.SetValue(100000.0)
        sizer_28.Add(self.levhams_wn_max_spinctrl, 0, 0, 0)

        sizer_19.Add((20, 10), 0, wx.EXPAND, 0)

        self.window_3_pane_2 = wx.Panel(self.window_3, wx.ID_ANY)

        sizer_21 = wx.BoxSizer(wx.HORIZONTAL)

        self.levhams_output_listctrl = wx.ListCtrl(self.window_3_pane_2, wx.ID_ANY, style=wx.LC_HRULES | wx.LC_REPORT)
        self.levhams_output_listctrl.AppendColumn("Energy (cm-1)", format=wx.LIST_FORMAT_LEFT, width=150)
        self.levhams_output_listctrl.AppendColumn("Wavenumber (cm-1)", format=wx.LIST_FORMAT_LEFT, width=150)
        self.levhams_output_listctrl.AppendColumn("Intensity", format=wx.LIST_FORMAT_LEFT, width=100)
        self.levhams_output_listctrl.AppendColumn("Level", format=wx.LIST_FORMAT_LEFT, width=150)
        self.levhams_output_listctrl.AppendColumn("J", format=wx.LIST_FORMAT_LEFT, width=50)
        self.levhams_output_listctrl.AppendColumn("New Level (cm-1)", format=wx.LIST_FORMAT_LEFT, width=150)
        self.levhams_output_listctrl.AppendColumn("Average Energy (cm-1)", format=wx.LIST_FORMAT_LEFT, width=200)
        sizer_21.Add(self.levhams_output_listctrl, 1, wx.ALL | wx.EXPAND, 3)

        self.window_3_pane_2.SetSizer(sizer_21)

        self.window_3_pane_1.SetSizer(sizer_19)
        ...
        self.Bind(wx.EVT_NOTEBOOK_PAGE_CHANGED, self.on_notebook_page_change, self.main_panel)
        ...
        self.Bind(wx.EVT_CHECKBOX, self.on_incorr_assign_tag, self.incorr_assign_chkbox)
        ...
        self.Bind(wx.EVT_LIST_ITEM_CHECKED, self.on_levhams_lev_checked, self.levhams_level_listctrl)
        self.Bind(wx.EVT_LIST_ITEM_UNCHECKED, self.on_levhams_lev_unchecked, self.levhams_level_listctrl)
    ...
    def on_lost_lines(self, event):  # wxGlade: mainWindow.<event_handler>
        print("Event handler 'on_lost_lines' not implemented!")
        event.Skip()
    ...
    def on_levhams(self, event):  # wxGlade: mainWindow.<event_handler>
        print("Event handler 'on_levhams' not implemented!")
        event.Skip()

    def on_notebook_page_change(self, event):  # wxGlade: mainWindow.<event_handler>
        print("Event handler 'on_notebook_page_change' not implemented!")
        event.Skip()
    ...
    def on_incorr_assign_tag(self, event):  # wxGlade: mainWindow.<event_handler>
        print("Event handler 'on_incorr_assign_tag' not implemented!")
        event.Skip()
    ...
    def on_levhams_lev_checked(self, event):  # wxGlade: mainWindow.<event_handler>
        print("Event handler 'on_levhams_lev_checked' not implemented!")
        event.Skip()

    def on_levhams_lev_unchecked(self, event):  # wxGlade: mainWindow.<event_handler>
        print("Event handler 'on_levhams_lev_unchecked' not implemented!")
        event.Skip()
...
class fixedLevelsDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        label_1 = wx.StaticText(self, wx.ID_ANY, "Please select fixed levels for Level Optimisation.\n\nAt least one level must be selected.", style=wx.ALIGN_CENTER_HORIZONTAL)
...
class propertiesDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        label_8 = wx.StaticText(self, wx.ID_ANY, "Line Matching")
        ...
        label_9 = wx.StaticText(self, wx.ID_ANY, "Wavenumber Matching Tolerance (cm-1)")
        ...
        label_10 = wx.StaticText(self, wx.ID_ANY, "Level Optimisation")
...
class lostLinesDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        # begin wxGlade: lostLinesDialog.__init__
        kwds["style"] = kwds.get("style", 0) | wx.DEFAULT_DIALOG_STYLE
        wx.Dialog.__init__(self, *args, **kwds)
        self.SetTitle("LOPT Fixed Level Selection")
        ...
        label_1 = wx.StaticText(self, wx.ID_ANY, "Select lines to be restored to Level Optimisation.", style=wx.ALIGN_CENTER_HORIZONTAL)
        sizer_1.Add(label_1, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, 10)

        self.lost_lines_lc = wx.ListCtrl(self, wx.ID_ANY, style=wx.BORDER_THEME | wx.LC_HRULES | wx.LC_REPORT | wx.LC_VRULES)
        self.lost_lines_lc.SetMinSize((500, 500))
        self.lost_lines_lc.AppendColumn("Wavenumber (cm-1)", format=wx.LIST_FORMAT_LEFT, width=200)
        self.lost_lines_lc.AppendColumn("User Designation", format=wx.LIST_FORMAT_LEFT, width=300)
        sizer_1.Add(self.lost_lines_lc, 1, wx.ALL | wx.EXPAND, 10)
        ...
        self.Bind(wx.EVT_LIST_ITEM_CHECKED, self.on_lost_lines_checked, self.lost_lines_lc)
        self.Bind(wx.EVT_LIST_ITEM_UNCHECKED, self.on_lost_lines_unchecked, self.lost_lines_lc)
        self.Bind(wx.EVT_BUTTON, self.on_lost_lines_ok, self.button_OK)
        # end wxGlade

    def on_lost_lines_checked(self, event):  # wxGlade: lostLinesDialog.<event_handler>
        print("Event handler 'on_lost_lines_checked' not implemented!")
        event.Skip()

    def on_lost_lines_unchecked(self, event):  # wxGlade: lostLinesDialog.<event_handler>
        print("Event handler 'on_lost_lines_unchecked' not implemented!")
        event.Skip()

    def on_lost_lines_ok(self, event):  # wxGlade: lostLinesDialog.<event_handler>
        print("Event handler 'on_lost_lines_ok' not implemented!")
        event.Skip()

# end of class lostLinesDialog
