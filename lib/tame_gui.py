...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Fri Oct  8 14:39:33 2021
#
...
class mainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu = wx.Menu()
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "Line Matching (partial)", "")
        self.Bind(wx.EVT_MENU, self.on_partial_strans, item)
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "Line Matching (full)", "")
        self.Bind(wx.EVT_MENU, self.on_full_strans, item)
        wxglade_tmp_menu.AppendSeparator()
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "Level Optimisation", "")
        ...
        self.levhams_output_ojlv = ObjectListViewTame(self.window_3_pane_2, wx.ID_ANY, style=wx.LC_REPORT|wx.SUNKEN_BORDER, sortable=False)
        sizer_21.Add(self.levhams_output_ojlv, 1, wx.EXPAND | wx.LEFT | wx.RIGHT | wx.TOP, 3)
        ...
        self.Bind(wx.EVT_LIST_ITEM_RIGHT_CLICK, self.on_levhams_right_click, self.levhams_output_ojlv)
    ...
    def on_levhams_right_click(self, event):  # wxGlade: mainWindow.<event_handler>
        print("Event handler 'on_levhams_right_click' not implemented!")
        event.Skip()
...
class fixedLevelsDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        kwds["style"] = kwds.get("style", 0) | wx.DEFAULT_DIALOG_STYLE
        wx.Dialog.__init__(self, *args, **kwds)
        self.SetTitle("Level Optimisation Fixed Level Selection")
...
class lostLinesDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        kwds["style"] = kwds.get("style", 0) | wx.DEFAULT_DIALOG_STYLE
        wx.Dialog.__init__(self, *args, **kwds)
        self.SetTitle("Lost Lines Reclamation")
