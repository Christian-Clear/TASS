...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Tue Aug 31 15:02:38 2021
#
...
class mainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        tool = self.frame_toolbar.AddTool(wx.ID_ANY, "Redo", wx.ArtProvider.GetBitmap(wx.ART_REDO, wx.ART_TOOLBAR, (24, 24)), wx.NullBitmap, wx.ITEM_NORMAL, "", "Run LEVHAMS")
        ...
        self.levhams_level_listctrl = wx.ListCtrl(self.window_3_pane_1, wx.ID_ANY, style=wx.BORDER_THEME | wx.LC_HRULES | wx.LC_REPORT | wx.LC_VRULES)
        ...
        self.levhams_level_listctrl.AppendColumn("Energy (cm-1)", format=wx.LIST_FORMAT_LEFT, width=250)
        ...
        levhams_inputs = wx.GridSizer(2, 3, 3, 3)
        sizer_20.Add(levhams_inputs, 1, wx.ALL | wx.EXPAND, 3)

        label_3 = wx.StaticText(self.window_3_pane_1, wx.ID_ANY, "Tolerance (cm-1)")
        levhams_inputs.Add(label_3, 0, wx.ALIGN_CENTER, 0)

        label_4 = wx.StaticText(self.window_3_pane_1, wx.ID_ANY, "Min. No. of Matches")
        levhams_inputs.Add(label_4, 0, wx.ALIGN_CENTER, 0)

        label_5 = wx.StaticText(self.window_3_pane_1, wx.ID_ANY, "Line Selection")
        levhams_inputs.Add(label_5, 0, wx.ALIGN_CENTER, 0)
        ...
        levhams_inputs.Add(self.levhams_tol_spinctrl, 0, wx.ALIGN_CENTER | wx.ALL, 5)

        self.levhams_num_spinctrl = wx.SpinCtrl(self.window_3_pane_1, wx.ID_ANY, "5", min=0, max=100)
        levhams_inputs.Add(self.levhams_num_spinctrl, 0, wx.ALIGN_CENTER | wx.ALL, 5)

        levhams_rb_sizer = wx.BoxSizer(wx.VERTICAL)
        levhams_inputs.Add(levhams_rb_sizer, 1, wx.EXPAND, 0)
