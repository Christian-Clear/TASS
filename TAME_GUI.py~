...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Thu Aug 26 17:16:57 2021
#
...
class mainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        label_4 = wx.StaticText(self.window_3_pane_1, wx.ID_ANY, "Min. Number of Matches")
        ...
        self.levhams_tol_txtctrl = wx.SpinCtrlDouble(self.window_3_pane_1, wx.ID_ANY, initial=0.005, min=0.0, max=100.0)
        self.levhams_tol_txtctrl.SetIncrement(0.001)
        self.levhams_tol_txtctrl.SetDigits(4)
        levhams_inputs.Add(self.levhams_tol_txtctrl, 0, wx.ALIGN_CENTER | wx.ALL, 5)

        self.levhams_num_txtctrl = wx.SpinCtrl(self.window_3_pane_1, wx.ID_ANY, "5", min=0, max=100)
        levhams_inputs.Add(self.levhams_num_txtctrl, 0, wx.ALIGN_CENTER | wx.ALL, 5)

        levhams_rb_sizer = wx.BoxSizer(wx.HORIZONTAL)
        levhams_inputs.Add(levhams_rb_sizer, 1, wx.ALIGN_CENTER, 0)

        self.radio_btn_1 = wx.RadioButton(self.window_3_pane_1, wx.ID_ANY, "All Lines", style=wx.RB_GROUP)
        levhams_rb_sizer.Add(self.radio_btn_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.radio_btn_2 = wx.RadioButton(self.window_3_pane_1, wx.ID_ANY, "Unidentified Lines")
        levhams_rb_sizer.Add(self.radio_btn_2, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        self.levhams_output_listctrl = wx.ListCtrl(self.window_3_pane_2, wx.ID_ANY, style=wx.LC_HRULES | wx.LC_REPORT | wx.LC_VRULES)
        self.levhams_output_listctrl.AppendColumn("Energy (cm-1)", format=wx.LIST_FORMAT_LEFT, width=200)
        self.levhams_output_listctrl.AppendColumn("Level", format=wx.LIST_FORMAT_LEFT, width=200)
        self.levhams_output_listctrl.AppendColumn("Average Energy (cm-1)", format=wx.LIST_FORMAT_LEFT, width=200)
        self.levhams_output_listctrl.AppendColumn("Level Width (cm-1)", format=wx.LIST_FORMAT_LEFT, width=200)
