...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Thu Mar 18 10:58:30 2021
#
...
class mainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.lopt_lev_ojlv = GroupListView(self.window_2_pane_1, wx.ID_ANY, style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL)
        ...
        sizer_11.Add(self.lopt_line_panel_header, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.TOP, 8)
        ...
        sizer_14 = wx.StaticBoxSizer(wx.StaticBox(self.lopt_line_panel, wx.ID_ANY, "Line Comments (press Enter to save)"), wx.VERTICAL)
        sizer_11.Add(sizer_14, 2, wx.ALL | wx.EXPAND, 3)
        ...
        sizer_11.Add(self.matplotlib_sizer, 6, wx.ALL | wx.EXPAND, 3)
        ...
        self.Bind(wx.EVT_TEXT_ENTER, self.on_lopt_comments, self.lopt_line_comments_txtctrl)
    ...
    def on_lopt_comments(self, event):  # wxGlade: mainWindow.<event_handler>
        print("Event handler 'on_lopt_comments' not implemented!")
        event.Skip()
