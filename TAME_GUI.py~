...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Wed Mar 24 16:01:54 2021
#
...
class NewProjectFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.SetTitle("New TAME Project")

        self.panel_1 = wx.Panel(self, wx.ID_ANY)

        sizer_1 = wx.BoxSizer(wx.VERTICAL)

        self.new_project_nb = wx.Notebook(self.panel_1, wx.ID_ANY, style=0)
        ...
        grid_sizer_2 = wx.FlexGridSizer(5, 3, 10, 10)
    ...
    def on_main_lev_file_btn(self, event):  # wxGlade: NewProjectFrame.<event_handler>
    ...
    def on_cancel(self, event):  # wxGlade: NewProjectFrame.<event_handler>
        print("Event handler 'on_cancel' not implemented!")
        event.Skip()

    def on_next(self, event):  # wxGlade: NewProjectFrame.<event_handler>
        print("Event handler 'on_next' not implemented!")
        event.Skip()

    def on_other_lev_files_btn(self, event):  # wxGlade: NewProjectFrame.<event_handler>
        print("Event handler 'on_other_lev_files_btn' not implemented!")
        event.Skip()

    def on_back(self, event):  # wxGlade: NewProjectFrame.<event_handler>
        print("Event handler 'on_back' not implemented!")
        event.Skip()

    def on_ok(self, event):  # wxGlade: NewProjectFrame.<event_handler>
