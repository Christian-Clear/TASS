...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Tue Feb 23 09:59:03 2021
#
...
class mainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.strans_level_list = wx.ListCtrl(self.window_1_pane_1, wx.ID_ANY, style=wx.LC_HRULES | wx.LC_REPORT | wx.LC_VRULES)
        self.strans_level_list.AppendColumn("Level Label", format=wx.LIST_FORMAT_LEFT, width=100)
        self.strans_level_list.AppendColumn("J", format=wx.LIST_FORMAT_LEFT, width=40)
        self.strans_level_list.AppendColumn("Energy (cm-1)", format=wx.LIST_FORMAT_LEFT, width=120)
        self.strans_level_list.AppendColumn("Parity", format=wx.LIST_FORMAT_LEFT, width=60)
        sizer_2.Add(self.strans_level_list, 1, wx.ALL | wx.EXPAND, 2)
        ...
        self.strans_lines_list = wx.ListCtrl(self.window_1_pane_2, wx.ID_ANY, style=wx.LC_HRULES | wx.LC_REPORT | wx.LC_VRULES)
        self.strans_lines_list.AppendColumn("Wavenumber (cm-1)", format=wx.LIST_FORMAT_LEFT, width=150)
        self.strans_lines_list.AppendColumn("SNR", format=wx.LIST_FORMAT_LEFT, width=50)
        self.strans_lines_list.AppendColumn("FHWM (mK)", format=wx.LIST_FORMAT_LEFT, width=100)
        self.strans_lines_list.AppendColumn("Eq. Width", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.strans_lines_list.AppendColumn("Fit", format=wx.LIST_FORMAT_LEFT, width=30)
        self.strans_lines_list.AppendColumn("Uncertainty (cm-1)", format=wx.LIST_FORMAT_LEFT, width=150)
        self.strans_lines_list.AppendColumn("Main Designations", format=wx.LIST_FORMAT_LEFT, width=600)
        self.strans_lines_list.AppendColumn("Other Designations", format=wx.LIST_FORMAT_LEFT, width=600)
        sizer_5.Add(self.strans_lines_list, 1, wx.ALL | wx.EXPAND, 2)
