...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Wed Sep  1 14:33:57 2021
#
...
class lostLinesDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        label_1 = wx.StaticText(self, wx.ID_ANY, "Select lines to be restored to LOPT.", style=wx.ALIGN_CENTER_HORIZONTAL)
        sizer_1.Add(label_1, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, 10)
